...
class AddConnectionFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (connectionId != null) {
            ...
            binding.typeGroup.check(R.id.type_sftp) // Set SFTP as default
            showSftpUi() // Ensure SFTP UI elements are visible
        }
    ...
    private fun showSftpUi(){
        binding.implicit.isVisible = false
        binding.privateData.isVisible = false
        binding.utf8.isVisible = false
        binding.passive.isVisible = false
        binding.privateKeyLayout.isVisible = true
        binding.port.setText(SSHClient.DEFAULT_PORT.toString()) // Set default SFTP port
        binding.safIntegration.isVisible = false
    }
